      ...
      <div class="border-t border-stone-800">
        <div class="container mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div class="flex gap-6 text-sm">
            <a href="#" class="text-warm-500 hover:text-warm-300 transition-colors">Polityka prywatności</a>
            <a href="#" class="text-warm-500 hover:text-warm-300 transition-colors">Regulamin</a>
          </div>
        </div>
      </div>
    </footer>
